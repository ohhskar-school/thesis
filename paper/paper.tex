...
The frame will then be converted to a 256 level grayscale image. This step will
be performed because future steps of the algorithm will not require color values
to work. In addition, the performance of these steps will be improved.
...
This filter will be used in the algorithm to obtain the four edges of the
keyboard.
